...
from graphic_arts import start_game_banner as s

def attack(char_name, char_class):
    """Выводим сообщение о атаке в соотвествии с выбранным классом"""
...
def defence(char_name, char_class):
    """Выводим сообщение о защите в соответсвии с выбранным классом"""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Выводим сообщение о супер-способности в соответсвии с выбранным классом"""
    if char_class == 'warrior': 
...
def start_training(char_name, char_class):
    """Меню выбора класса и вывод информативных сообщений
        Запуск цикла основного меню игрового процесса"""
    if char_class == 'warrior':
